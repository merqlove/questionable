...
radio, checkboxes, date, text, and string.
  ...
  q = Questionable::Question.create(title: 'What is your favorite color?', input_type: 'select', note: 'This is important', category => 'comment' )
  q = Questionable::Question.create(title: 'What is your favorite color?', input_type: 'string', note: 'This is important', category => 'comment' )
...
controllers/some_controller.rb
  ...
  @answers = @questions.map{ |question| questions.answers }
